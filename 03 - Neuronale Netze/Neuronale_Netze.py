...
def _():
    ...
    return Net, erstes_nn, nn, param, test_eingabe, torch, warnings
...
def _(erstes_nn):
    ...
    return gewicht1, gewicht2, gewicht3, gewicht4, pruefe_gewichte
...
def _(
    ...
    return accuracy_res, e, loss, loss_res, outputs
...
@app.cell
def _():
    from public.resources.code.help_functions import daten2, datenpunkte_zeichnen
